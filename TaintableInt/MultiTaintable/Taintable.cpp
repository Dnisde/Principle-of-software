...
void Multiple_Test()
{
    MultiTaintable<int, string> xx{3};
    MultiTaintable<int, string> yy{5};
    cout << xx << endl;
    MultiTaintable<int, string>::taint(xx,"hi");
    MultiTaintable<int, string>::taint(yy,"there");
    MultiTaintable<int, string>::taint(yy,"!");
    xx = xx + 3;
    cout << xx << endl;
    cout << xx + 3 << endl;
    cout << &(xx*yy) << endl;
    ...
    cout << xx++ << endl;
    cout << ++xx << endl;
    // It will print 1 when two side of operands are equals:
    cout << (xx==yy) << endl;
    const int test_num = 8;
    cout << (xx==test_num) << endl;
}
...
std::array<MultiTaintable<int, string>, SIZE> theHash(std::array<MultiTaintable<int, string>, SIZE> &input, bool taint) {
    ...
    if (taint) {
        for (int i = 0; i < SIZE; i++) {
            /**
             * Suppose we enter a random password ,
